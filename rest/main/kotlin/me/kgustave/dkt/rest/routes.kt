...
@ExperimentalDktREST
open class BasicRoute internal constructor(
...
@ExperimentalDktREST
class FormattedRoute internal constructor(
    val base: BasicRoute,
...
@ExperimentalDktREST
class DeleteMessageRoute
internal constructor(queryParams: List<Pair<String, String?>> = emptyList()): BasicRoute(
    method = Delete,
