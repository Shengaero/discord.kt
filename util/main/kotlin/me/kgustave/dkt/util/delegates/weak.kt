...
import me.kgustave.dkt.util.unsafeCast
...
class WeakDelegate<T> internal constructor(value: T) {
    ...
    operator fun getValue(instance: Any?, property: KProperty<*>): T {
        ...
        // unsafe cast to T instead of not-null assertion (!!).
        // This allows us to trick kotlin compiler into returning a
        //value that may or may not be null even though T is "null-invariant".
