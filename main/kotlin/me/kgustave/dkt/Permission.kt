...
enum class Permission(
    ...
    companion object {
        ...
        @JvmField val AllRaw = rawOf(All)
        @JvmField val AllGuild = All.filter(Permission::isGuild)
        @JvmField val AllGuildRaw = rawOf(AllGuild)
        @JvmField val AllChannel = All.filter(Permission::isChannel)
        @JvmField val AllChannelRaw = rawOf(AllChannel)
        @JvmField val AllText = All.filter(Permission::isText)
        @JvmField val AllTextRaw = rawOf(AllText)
        @JvmField val AllVoice = All.filter(Permission::isVoice)
        @JvmField val AllVoiceRaw = rawOf(AllVoice)

        @ExperimentalUnsignedTypes val AllURaw = unsignedRawOf(All)
        @ExperimentalUnsignedTypes val AllGuildURaw = unsignedRawOf(AllGuild)
        @ExperimentalUnsignedTypes val AllChannelURaw = unsignedRawOf(AllChannel)
        @ExperimentalUnsignedTypes val AllTextURaw = unsignedRawOf(AllText)
        @ExperimentalUnsignedTypes val AllVoiceURaw = unsignedRawOf(AllVoice)
        ...
        @JvmStatic
        fun rawOf(permissions: Collection<Permission>): Long = rawOf(*permissions.toTypedArray())
        ...
        @JvmStatic
        @ExperimentalUnsignedTypes
        fun unsignedRawOf(permissions: Collection<Permission>): ULong = unsignedRawOf(*permissions.toTypedArray())
