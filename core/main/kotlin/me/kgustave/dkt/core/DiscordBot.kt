...
import me.kgustave.dkt.core.handle.*
import me.kgustave.dkt.core.internal.handle.EventManagerImpl
...
interface DiscordBot {
    ...
    suspend fun await(status: Status): DiscordBot

    suspend fun awaitReady(): DiscordBot = await(Status.CONNECTED)
    ...
    open class Config {
        ...
        @BotConfigDsl
        fun okHttp(okHttp: OkHttpClient.Builder.() -> Unit) {
            this.okHttp = okHttp
        }
